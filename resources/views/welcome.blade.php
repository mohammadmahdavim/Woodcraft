                ...
                @can('manage-classes')
                    <li><a href="widgets.html"><i class="icon-book"></i> &nbsp
                        ...
                        <ul>
                            ...
                            <li><a href="/admin/maghta"><i class="icon-collaboration"></i> &nbsp &nbsp
                                    <span>مقاطع</span> </a></li>
                                        ...
                                        <ul>
                                            ...
                                            @foreach($claas as $cls)
                                                <a href="/admin/students/singlepage/{{$cls->classnamber}}">
                                                    <li value="{{$cls->classnamber	}}">{{$cls->description}}</li>
                                                </a>
                                                @endforeach
                                                </li>
                                        </ul>
                                                    ...
                                                    <ul>
                                                        @foreach($claas as $cls)
                                                            <a href="/admin/rollcall/class/{{$cls->classnamber}}">
                                                                <li value="{{$cls->classnamber	}}">{{$cls->description}}
                                                                    </li>
                                                            </a>
                                                        @endforeach
                                                    </ul>
...
{{--                                @foreach($data as $cls)--}}
{{--                                    <a href="/admin/createmarkshow/{{$cls->class[0]->classnamber}}/{{$cls->darss[0]->id}}">--}}
{{--                                        <li>--}}
...
{{--                            <ul>--}}
{{--                                @foreach($data as $cls)--}}
{{--                                    <a href="/admin/viewmark/{{$cls->class[0]->classnamber}}/{{$cls->darss[0]->id}}">--}}
{{--                                        <li>--}}
{{--                                            {{$cls->class[0]->paye}}-{{$cls->class[0]->classnamber}}--}}
{{--                                            -{{$cls->darss[0]->name}}--}}
{{--                                        </li>--}}
...
{{--                                @endforeach--}}
{{--                                --}}{{--@foreach($claas as $cls)--}}
{{--                                --}}{{--<a href="/admin/viewmark/{{$cls->classnamber}}">--}}
{{--                                --}}{{--<li value="{{$cls->classnamber}}">{{$cls->paye}}--}}
{{--                                --}}{{---{{$cls->classnamber}}</li>--}}
{{--                                --}}{{--</a>--}}
{{--                                --}}{{--@endforeach--}}
...
{{--                </li>--}}
                ...
                @endcan
    {{--            <li><a href="#"><i class="icon-newspaper"></i> &nbsp &nbsp<span>مدیریت انتخابات</span> </a>--}}
    {{--                <ul>--}}
    {{--                    <li><a href="/admin/selection_index"> انتخابات--}}
    {{--                        </a>--}}
    {{--                    </li>--}}
    {{--                    <li><a href="/admin/template_selection_index"> قالب سوالات--}}
    {{--                        </a>--}}
    {{--                    </li>--}}
    {{--                    <li><a href="/admin/template_answer_index">قالب پاسخ ها--}}
    {{--                        </a>--}}
    {{--                    </li>--}}
    {{--                </ul>--}}
    {{--            </li>--}}
